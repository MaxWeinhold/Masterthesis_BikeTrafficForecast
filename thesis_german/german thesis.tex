...
\begin{lstlisting}[caption={Berechnung der Straßenvariablen}]
...
\begin{lstlisting}[caption={Zuordnung zur nächsten Straße}]
j=1
...
\end{lstlisting}
\label{code:street_variables2}

Die Variable \lstinline|nearest| gibt nun an, welche Straße die nächstgelegenste zur Zählstation ist und mit diesen Informationen lassen sich die weiteren notwendigen Variablen berechnen.
