...
\begin{acronym}
	\acro{ADFC}{Allgemeiner-Deutsche-Fahrrad-Club}
	\acro{bzw.}{beziehungsweise}
	\acro{ca.}{circa}
	\acro{CHAID}{Chi-Squared-Automatic-Interaction-Detection}
	\acro{Destatis}{Bundesamt für Statistik}
	\acro{Mio.}{Million}
	\acro{OLS}{Ordinary Least Square}
	\acro{PM$_{2.5}$}{Feinstaubpartikel kleiner als 2,5 Mikrometer}
	\acro{POI}{Point of Interest}
	\acro{ReLU}{Rectified-Linear-Unit}
	\acro{RKI}{Robert-Koch-Institut}
	\acro{RMSE}{Root-Mean-Squared-Error}
	\acro{RSS}{Residuenquadratsumme}
...
\begin{figure}%
	\centering
	\subfloat[\centering Angenommene Bevölkerungsentwicklung in Hamburg]{{\includegraphics[width=6cm]{Plots/Forecast_Hamburg_plot01.png} }}%
	\qquad
	\subfloat[\centering Angenommene demographische Entwicklung in Hamburg]{{\includegraphics[width=6cm]{Plots/Forecast_Hamburg_plot04.png} }}%
	\caption{Stadtentwicklungsprognose}%
	\label{fig:Forecast1}%
\end{figure}

Die aus diesen Vorhersagen resultierende Radverkehrsentwicklung zeigt Abbildung \ref{fig:Forecast2}.

\begin{figure}%
	\centering
	\subfloat[\centering Monatliche Radverkehrsprognose]{{\includegraphics[width=6cm]{Plots/Forecast_Hamburg.png} }}%
	\qquad
	\subfloat[\centering Jährliche Radverkehrsprognose]{{\includegraphics[width=6cm]{Plots/Forecast_Hamburg_pa.png} }}%
	\caption{Radverkehrsentwicklungsprognose für Hamburg}%
	\label{fig:Forecast2}%
\end{figure}
...
Die Fähigkeiten des Modells lassen sich rein graphisch nur begrenzt darstellen, da das Modell nicht nur räumlich, sondern auch zeitliche Vorhersagen treffen kann. Einen Eindruck dessen vermittelt das Video\footnote{\url{https://www.youtube.com/watch?v=ekOlsjMuOfc}, letzter Zugriff: 1.3.2023}, das im Zuge dieser Masterarbeit mit Vorhersagen des Modells erstellt worden ist.
...
\begin{figure}%
	\centering
	\subfloat[\centering Berlin großer Zoom]{{\includegraphics[width=10.5cm]{Plots/Berlin.png} }}%
	
	\subfloat[\centering Berin kleiner Zoom]{{\includegraphics[width=10.5cm]{Plots/Berlin_Hauptstraßen.png} }}%
	\caption{Kartendarstellung mit unterschiedlichen Details}%
	\label{fig:Berlin}%
\end{figure}

\begin{figure}%
	\centering
	\subfloat[\centering Leipzig bei kaltem Wetter]{{\includegraphics[width=10.5cm]{Plots/LeipzigWetter1.png} }}%
	
	\subfloat[\centering Leipzig bei heißem Wetter]{{\includegraphics[width=10.5cm]{Plots/LeipzigWetter2.png} }}%
	\caption{Kartendarstellung mit unterschiedlichem Wetter}%
	\label{fig:TemperaturunterschiedeaufKarte}%
\end{figure}
