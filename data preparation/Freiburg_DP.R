...
#D:\STUDIUM\Münster\7. Semester\Masterarbeit Daten\Freiburg
...
levels(as.factor(rawData$standort))
rawData<-rawData[(rawData$standort=="Stadt Freiburg"),]
rawData$standort = "Freiburg"
names(rawData)
...
#Import Weather Data
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Freiburg")
...
ADFC_Index=c(3.1,3.1,3.3,3.3,3.3,3.3,3.4,3.4,3.3,3.3)
...
test12=as.data.frame(Destatis12[Destatis12$X.6 == "Freiburg im Breisgau, Stadt",])
test12[17] <- NULL
test12[17] <- NULL
...
test13=as.data.frame(Destatis13[Destatis13$X.6 == "Freiburg im Breisgau, Stadt",])
test13[17] <- NULL
test13[17] <- NULL
...
test14=as.data.frame(Destatis14[Destatis14$X.6 == "Freiburg im Breisgau, Stadt",])
test14[17] <- NULL
test14[17] <- NULL
...
test15=as.data.frame(Destatis15[Destatis15$X.6 == "Freiburg im Breisgau, Stadt",])
test15[17] <- NULL
test15[17] <- NULL
...
test16=as.data.frame(Destatis16[Destatis16$X.6 == "Freiburg im Breisgau, Stadt",])
test16[17] <- NULL
test16[17] <- NULL
...
test17=as.data.frame(Destatis17[Destatis17$X.6 == "Freiburg im Breisgau, Stadt",])
test17[17] <- NULL
test17[17] <- NULL
...
test18=as.data.frame(Destatis18[Destatis18$X.6 == "Freiburg im Breisgau, Stadt",])
test18[17] <- NULL
test18[17] <- NULL
...
test19=as.data.frame(Destatis19[Destatis19$X.6 == "Freiburg im Breisgau, Stadt",])
test19[17] <- NULL
test19[17] <- NULL
...
test20=as.data.frame(Destatis20[Destatis20$X.6 == "Freiburg im Breisgau, Stadt",])
test20[17] <- NULL
test20[17] <- NULL
...
test21=as.data.frame(Destatis21[Destatis21$X.6 == "Freiburg im Breisgau, Stadt",])
test21[17] <- NULL
test21[17] <- NULL
