...
#Read Bycicle Counting Data----------------------------------------------
  ...
  S11BruehlerStr_18=ddply(countingData_BrühlerStraße_2018,.(Uhrzeit),summarize,Value=sum(X5.11.BN...BrÃ.hler.StraÃŸe))
  ...
  S12StrassburgerWeg_18=ddply(countingData_StraßburgerWeg_2018,.(Uhrzeit),summarize,Value=sum(X5.12.BN...StraÃŸburger.Weg))
  ...
  countingData_Bonn_2019=ddply(countingData_Bonn_2019,.(Uhrzeit),summarize,
                        S01KennedyBR_N=sum(X5.01.BN...KennedybrŸcke..Nordseite.),
                        S02KennedyBR_S=sum(X5.02.BN...KennedybrŸcke..SŸdseite..Barometer),
                        S03NordBR_S=sum(X5.03.BN...NordbrŸcke..SŸdseite.),
                        S04NordBR_N=sum(X5.04.BN...NordbrŸcke..Nordseite.),
                        S05SuedBR_S=sum(X5.05.BN...SŸdbrŸcke..SŸdseite.),
                        S06SuedBR_N=sum(X5.06.BN...SŸdbrŸcke..Nordseite.),
                        ...
                        S10Broehltalweg=sum(X5.10.BN...Bršhltalweg),
                        S11BruehlerStr=sum(X5.11.BN...BrŸhler.Stra.e),
  ...
  countingData_Bonn_2020_1=ddply(countingData_Bonn_2020_1,.(Uhrzeit),summarize,
                               ...
                               S11BruehlerStr=sum(X5.11.BN...BrÃ.hler.StraÃŸe),
                               S13WilhelmSpiritusUfer=sum(X5.13.BN...Wilhelm.Spiritus.Ufer),
                               S14McCloyWeg=sum(X5.14.BN...Mc.Cloy.Weg),
                               S15WegDammBonnBeuel=sum(X5.15.BN...Weg.auf.Damm.Neil))  
