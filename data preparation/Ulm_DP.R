...
#D:\STUDIUM\Münster\7. Semester\Masterarbeit Daten\Ulm
...
rawData<-rawData[(rawData$standort=="Stadt Ulm"),]
rawData$standort = "Ulm"
names(rawData)
...
#Import Weather Data
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Ulm")
...
ADFC_Index=c(3.6,3.6,3.4,3.4,3.6,3.6,3.9,3.9,3.9,3.9)
