...
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Tübingen")

#Read Bycicle Counting Data----------------------------------------------
  countingData_Hirschau = read.csv(file = "Hirschau.csv",sep=";", encoding="ISO-8859-1")
  countingData_Radtunnel = read.csv(file = "Radtunnel.csv",sep=";", encoding="ISO-8859-1")
  countingData_Steinlachallee = read.csv(file = "Steinlachallee.csv",sep=";", encoding="ISO-8859-1")
  
#Summarize Directions----------------------------------------------
  
  names(countingData_Steinlachallee)
  countingData_Hirschau$Wert = countingData_Hirschau$Richtung.Neckar.Tübingen + countingData_Hirschau$Richtung.Hirschau
  countingData_Radtunnel$Wert = countingData_Radtunnel$Richtung.Altstadt + countingData_Radtunnel$Richtung.Bahnhof
  countingData_Steinlachallee$Wert = countingData_Steinlachallee$Richtung.Altstadt + countingData_Steinlachallee$Richtung.Derendingen
  
#Change count frequency to hourly data----------------------------------------------
  
  countingData_Steinlachallee$Timestamp=cut(strptime(countingData_Steinlachallee$Kanalname,"%Y-%m-%d %H:%M"),"hour")
  countingData_Steinlachallee=ddply(countingData_Steinlachallee,.(Timestamp),summarize,Value=sum(Wert))
  
  countingData_Radtunnel$Timestamp=cut(strptime(countingData_Radtunnel$Kanalname,"%Y-%m-%d %H:%M"),"hour")
  countingData_Radtunnel=ddply(countingData_Radtunnel,.(Timestamp),summarize,Value=sum(Wert))
  
  countingData_Hirschau$Timestamp=cut(strptime(countingData_Hirschau$Kanalname,"%Y-%m-%d %H:%M"),"hour")
  countingData_Hirschau=ddply(countingData_Hirschau,.(Timestamp),summarize,Value=sum(Wert))
  
#Add Location Columns----------------------------------------------
  
  countingData_Steinlachallee$Town = "Tübingen"
  countingData_Radtunnel$Town = "Tübingen"
  countingData_Hirschau$Town = "Tübingen"
  
  countingData_Steinlachallee$Station = "Steinlachallee"
  countingData_Radtunnel$Station = "Radtunnel"
  countingData_Hirschau$Station = "Hirschau"
  
  
  countingData_Steinlachallee$Lon = 9.058848278452603
  countingData_Radtunnel$Lon = 9.047967820493513
  countingData_Hirschau$Lon = 9.02490931228748
  
  countingData_Steinlachallee$Lat = 48.515503997594905
  countingData_Radtunnel$Lat = 48.51804998727401
  countingData_Hirschau$Lat = 48.50354422749164
  
  countingData_Steinlachallee$Oneway = FALSE
  countingData_Radtunnel$Oneway = FALSE
  countingData_Hirschau$Oneway = FALSE
  
#Connect the Stations----------------------------------------------
  
  rawData=rbind(countingData_Steinlachallee,countingData_Radtunnel)
  rawData=rbind(rawData,countingData_Hirschau)
...
# Adding ADFC-Fahrradklima Values
  ...
  ADFC_Index=c(3.3,3.3,3.1,3.1,3.4,3.4,3.5,3.5,3.4,3.4)
