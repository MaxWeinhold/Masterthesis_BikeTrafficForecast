...
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Konstanz")

#Read Bycicle Counting Data----------------------------------------------
  countingData_2018 = read.csv(file = "Zaehlstelle_Herose_2018_stuendlich_Wetter.csv",sep=";")
  countingData_2019 = read.csv(file = "Zaehlstelle_Herose_2019_stuendlich_Wetter.csv",sep=";")
  countingData_2020 = read.csv(file = "Zaehlstelle_Herose_2020_stuendlich_Wetter.csv",sep=";")
  countingData_2021 = read.csv(file = "Zaehlstelle_Herose_2021_stuendlich_Wetter.csv",sep=",")

#Delete unneeded columns-------------------------------------------------
  
  countingData_2018[3:8]=NULL
  countingData_2019[4:9]=NULL
  countingData_2020[3:8]=NULL
  countingData_2021[4:10]=NULL
  
#Rename columns----------------------------------------------------------
  
  names(countingData_2018)[1]="Timestamp"
  names(countingData_2018)[2]="Value"
  names(countingData_2020)[1]="Timestamp"
  names(countingData_2020)[2]="Value"
  
  countingData_2019$Timestamp = paste(countingData_2019$Datum,countingData_2019$Uhrzeit)
  countingData_2019$Datum = NULL
  countingData_2019$Uhrzeit = NULL
  names(countingData_2019)[1]="Value"
  
  
  countingData_2021[1]=NULL
  names(countingData_2021)[1]="Timestamp"
  names(countingData_2021)[2]="Value"
  
#Connect Year------------------------------------------------------------

  rawData = rbind(countingData_2018,countingData_2019)
  rawData = rbind(rawData,countingData_2020)
  rawData = rbind(rawData,countingData_2021)
  rm(countingData_2018,countingData_2019,countingData_2020,countingData_2021)

#Add Location Columns----------------------------------------------
  
  rawData$Town = "Konstanz"
  rawData$Station = "Herose"
  rawData$Lon = 9.174641287558822
  rawData$Lat = 47.66935867731206
  rawData$Oneway = FALSE
...
# Adding ADFC-Fahrradklima Values
  ...
  ADFC_Index=c(3.5,3.5,3.4,3.4,3.4,3.4,3.1,3.1,3.2,3.2)
...
#Using the overpass API 
  ...
  q <- getbb(toString(rawData$Town[1])) %>%
    ...
    add_osm_feature("operator", "DB Station&Service AG")
