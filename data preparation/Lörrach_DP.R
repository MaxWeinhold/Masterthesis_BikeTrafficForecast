...
#D:\STUDIUM\Münster\7. Semester\Masterarbeit Daten\Lörrach
...
rawData<-rawData[(rawData$standort=="Stadt LÃ¶rrach"),]
rawData$standort = "Lörrach"
names(rawData)
...
#Import Weather Data
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Lörrach")
...
ADFC_Index=c(2.8,2.8,3.0,3.0,3.2,3.2,3.8,3.8,3.7,3.7)
...
q <- getbb(toString(rawData$Town[1])) %>%
  ...
  add_osm_feature("operator", "SBB Deutschland GmbH")
