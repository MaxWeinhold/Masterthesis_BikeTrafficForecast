...
#D:\STUDIUM\Münster\7. Semester\Masterarbeit Daten\Leipzig
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Leipzig")

#Read Bycicle Counting Data----------------------------------------------
  countingData = read.csv(file = "Dauerzahlstellen_Rad.csv",sep=";", encoding="ISO-8859-1")
  names(countingData)

#Divide raw data per stations----------------------------------------------
  countingData_EisenbahnStr_Nord        = as.data.frame(cbind(countingData$Datum,countingData$Eisenbahnstraße.Nord))
  countingData_EisenbahnStr_Sued        = as.data.frame(cbind(countingData$Datum,countingData$Eisenbahnstraße.Süd))
  countingData_NuernbergerStr_Ost       = as.data.frame(cbind(countingData$Datum,countingData$FGÜ.Nürnberger.Straße.OST..Schule.))
  countingData_NuernbergerStr_West      = as.data.frame(cbind(countingData$Datum,countingData$FGÜ.Nürnberger.Straße.WEST..Edeka.))
  countingData_GerberStr                = as.data.frame(cbind(countingData$Datum,countingData$Gerberstraße))
  countingData_GorkiStr_Ost             = as.data.frame(cbind(countingData$Datum,countingData$Gorkistraße.Ostseite))
  countingData_GorkiStr_West            = as.data.frame(cbind(countingData$Datum,countingData$Gorkistraße.Westseite))
  countingData_GustavFreytagStr_Nord    = as.data.frame(cbind(countingData$Datum,countingData$Gustav.Freytag.Straße..Nord.))
  countingData_GustavFreytagStr_Sued    = as.data.frame(cbind(countingData$Datum,countingData$Gustav.Freytag.Straße..Süd.))
  countingData_Jahnallee                = as.data.frame(cbind(countingData$Datum,countingData$Jahnallee))
  countingData_KarlLiebknecht           = as.data.frame(cbind(countingData$Datum,countingData$Karl.Liebknecht))
  countingData_LeneVoigtPark            = as.data.frame(cbind(countingData$Datum,countingData$Lene.Voigt.Park))
  countingData_ManetStr                 = as.data.frame(cbind(countingData$Datum,countingData$Manetstraße))
  countingData_MerseburgerStr_Ost       = as.data.frame(cbind(countingData$Datum,countingData$Merseburger.Str....Aurelienstr..Ostseite))
  countingData_MerseburgerStr_West      = as.data.frame(cbind(countingData$Datum,countingData$Merseburger.Str....Aurelienstr..Westseite))
  countingData_SemmelweisStr            = as.data.frame(cbind(countingData$Datum,countingData$Semmelweisstraße))
  countingData_WurznerStr               = as.data.frame(cbind(countingData$Datum,countingData$Wurzner.Straße))
  
  countingData_EisenbahnStr_Nord        = as.data.frame(cbind(countingData$Uhrzeit,countingData_EisenbahnStr_Nord))
  countingData_EisenbahnStr_Sued        = as.data.frame(cbind(countingData$Uhrzeit,countingData_EisenbahnStr_Sued))
  countingData_NuernbergerStr_Ost       = as.data.frame(cbind(countingData$Uhrzeit,countingData_NuernbergerStr_Ost))
  countingData_NuernbergerStr_West      = as.data.frame(cbind(countingData$Uhrzeit,countingData_NuernbergerStr_West))
  countingData_GerberStr                = as.data.frame(cbind(countingData$Uhrzeit,countingData_GerberStr))
  countingData_GorkiStr_Ost             = as.data.frame(cbind(countingData$Uhrzeit,countingData_GorkiStr_Ost))
  countingData_GorkiStr_West            = as.data.frame(cbind(countingData$Uhrzeit,countingData_GorkiStr_West))
  countingData_GustavFreytagStr_Nord    = as.data.frame(cbind(countingData$Uhrzeit,countingData_GustavFreytagStr_Nord))
  countingData_GustavFreytagStr_Sued    = as.data.frame(cbind(countingData$Uhrzeit,countingData_GustavFreytagStr_Sued))
  countingData_Jahnallee                = as.data.frame(cbind(countingData$Uhrzeit,countingData_Jahnallee))
  countingData_KarlLiebknecht           = as.data.frame(cbind(countingData$Uhrzeit,countingData_KarlLiebknecht))
  countingData_LeneVoigtPark            = as.data.frame(cbind(countingData$Uhrzeit,countingData_LeneVoigtPark))
  countingData_ManetStr                 = as.data.frame(cbind(countingData$Uhrzeit,countingData_ManetStr))
  countingData_MerseburgerStr_Ost       = as.data.frame(cbind(countingData$Uhrzeit,countingData_MerseburgerStr_Ost))
  countingData_MerseburgerStr_West      = as.data.frame(cbind(countingData$Uhrzeit,countingData_MerseburgerStr_West))
  countingData_SemmelweisStr            = as.data.frame(cbind(countingData$Uhrzeit,countingData_SemmelweisStr))
  countingData_WurznerStr               = as.data.frame(cbind(countingData$Uhrzeit,countingData_WurznerStr))
  
#Rename Columns----------------------------------------------
  
  names(countingData_EisenbahnStr_Nord)[1]="Date"
  names(countingData_EisenbahnStr_Sued)[1]="Date"
  names(countingData_NuernbergerStr_Ost)[1]="Date"
  names(countingData_NuernbergerStr_West)[1]="Date"
  names(countingData_GerberStr)[1]="Date"
  names(countingData_GorkiStr_Ost)[1]="Date"
  names(countingData_GorkiStr_West)[1]="Date"
  names(countingData_GustavFreytagStr_Nord)[1]="Date"
  names(countingData_GustavFreytagStr_Sued)[1]="Date"
  names(countingData_Jahnallee)[1]="Date"
  names(countingData_KarlLiebknecht)[1]="Date"
  names(countingData_LeneVoigtPark)[1]="Date"
  names(countingData_ManetStr)[1]="Date"
  names(countingData_MerseburgerStr_Ost)[1]="Date"
  names(countingData_MerseburgerStr_West)[1]="Date"
  names(countingData_SemmelweisStr)[1]="Date"
  names(countingData_WurznerStr)[1]="Date"
  
  names(countingData_EisenbahnStr_Nord)[2]="Time"
  names(countingData_EisenbahnStr_Sued)[2]="Time"
  names(countingData_NuernbergerStr_Ost)[2]="Time"
  names(countingData_NuernbergerStr_West)[2]="Time"
  names(countingData_GerberStr)[2]="Time"
  names(countingData_GorkiStr_Ost)[2]="Time"
  names(countingData_GorkiStr_West)[2]="Time"
  names(countingData_GustavFreytagStr_Nord)[2]="Time"
  names(countingData_GustavFreytagStr_Sued)[2]="Time"
  names(countingData_Jahnallee)[2]="Time"
  names(countingData_KarlLiebknecht)[2]="Time"
  names(countingData_LeneVoigtPark)[2]="Time"
  names(countingData_ManetStr)[2]="Time"
  names(countingData_MerseburgerStr_Ost)[2]="Time"
  names(countingData_MerseburgerStr_West)[2]="Time"
  names(countingData_SemmelweisStr)[2]="Time"
  names(countingData_WurznerStr)[2]="Time"
  
  names(countingData_EisenbahnStr_Nord)[3]="Value"
  names(countingData_EisenbahnStr_Sued)[3]="Value"
  names(countingData_NuernbergerStr_Ost)[3]="Value"
  names(countingData_NuernbergerStr_West)[3]="Value"
  names(countingData_GerberStr)[3]="Value"
  names(countingData_GorkiStr_Ost)[3]="Value"
  names(countingData_GorkiStr_West)[3]="Value"
  names(countingData_GustavFreytagStr_Nord)[3]="Value"
  names(countingData_GustavFreytagStr_Sued)[3]="Value"
  names(countingData_Jahnallee)[3]="Value"
  names(countingData_KarlLiebknecht)[3]="Value"
  names(countingData_LeneVoigtPark)[3]="Value"
  names(countingData_ManetStr)[3]="Value"
  names(countingData_MerseburgerStr_Ost)[3]="Value"
  names(countingData_MerseburgerStr_West)[3]="Value"
  names(countingData_SemmelweisStr)[3]="Value"
  names(countingData_WurznerStr)[3]="Value"
  
#Add Location Columns----------------------------------------------
  
  countingData_EisenbahnStr_Nord$Town = "Leipzig"
  countingData_EisenbahnStr_Sued$Town = "Leipzig"
  countingData_NuernbergerStr_Ost$Town = "Leipzig"
  countingData_NuernbergerStr_West$Town = "Leipzig"
  countingData_GerberStr$Town = "Leipzig"
  countingData_GorkiStr_Ost$Town = "Leipzig"
  countingData_GorkiStr_West$Town = "Leipzig"
  countingData_GustavFreytagStr_Nord$Town = "Leipzig"
  countingData_GustavFreytagStr_Sued$Town = "Leipzig"
  countingData_Jahnallee$Town = "Leipzig"
  countingData_KarlLiebknecht$Town = "Leipzig"
  countingData_LeneVoigtPark$Town = "Leipzig"
  countingData_ManetStr$Town = "Leipzig"
  countingData_MerseburgerStr_Ost$Town = "Leipzig"
  countingData_MerseburgerStr_West$Town = "Leipzig"
  countingData_SemmelweisStr$Town = "Leipzig"
  countingData_WurznerStr$Town = "Leipzig"
  
  countingData_EisenbahnStr_Nord$Station = "EisenbahnStr"
  countingData_EisenbahnStr_Sued$Station = "EisenbahnStr"
  countingData_NuernbergerStr_Ost$Station = "NuernbergerStr"
  countingData_NuernbergerStr_West$Station = "NuernbergerStr"
  countingData_GerberStr$Station = "GerberStr"
  countingData_GorkiStr_Ost$Station = "GorkiStr"
  countingData_GorkiStr_West$Station = "GorkiStr"
  countingData_GustavFreytagStr_Nord$Station = "GustavFreytagStr"
  countingData_GustavFreytagStr_Sued$Station = "GustavFreytagStr"
  countingData_Jahnallee$Station = "Jahnallee"
  countingData_KarlLiebknecht$Station = "KarlLiebknecht"
  countingData_LeneVoigtPark$Station = "LeneVoigtPark"
  countingData_ManetStr$Station = "ManetStr"
  countingData_MerseburgerStr_Ost$Station = "MerseburgerStr"
  countingData_MerseburgerStr_West$Station = "MerseburgerStr"
  countingData_SemmelweisStr$Station = "SemmelweisStr"
  countingData_WurznerStr$Station = "WurznerStr"
  
  countingData_EisenbahnStr_Nord$Lon = 12.38
  countingData_EisenbahnStr_Sued$Lon = 12.38
  countingData_NuernbergerStr_Ost$Lon = 12.38
  countingData_NuernbergerStr_West$Lon = 12.38
  countingData_GerberStr$Lon = 12.376690562113938
  countingData_GorkiStr_Ost$Lon = 12.38
  countingData_GorkiStr_West$Lon = 12.38
  countingData_GustavFreytagStr_Nord$Lon = 12.38
  countingData_GustavFreytagStr_Sued$Lon = 12.38
  countingData_Jahnallee$Lon = 12.345546453973583
  countingData_KarlLiebknecht$Lon = 12.373749575447198
  countingData_LeneVoigtPark$Lon = 12.39916800149741
  countingData_ManetStr$Lon = 12.367753713650481
  countingData_MerseburgerStr_Ost$Lon = 12.38
  countingData_MerseburgerStr_West$Lon = 12.38
  countingData_SemmelweisStr$Lon = 12.386320751441511
  countingData_WurznerStr$Lon = 12.38
  
  countingData_EisenbahnStr_Nord$Lat = 51.32
  countingData_EisenbahnStr_Sued$Lat = 51.32
  countingData_NuernbergerStr_Ost$Lat = 51.32
  countingData_NuernbergerStr_West$Lat = 51.32
  countingData_GerberStr$Lat = 51.34655704429972
  countingData_GorkiStr_Ost$Lat = 51.32
  countingData_GorkiStr_West$Lat = 51.32
  countingData_GustavFreytagStr_Nord$Lat = 51.32
  countingData_GustavFreytagStr_Sued$Lat = 51.32
  countingData_Jahnallee$Lat = 51.33928677361041
  countingData_KarlLiebknecht$Lat = 51.32677851766502
  countingData_LeneVoigtPark$Lat = 51.3344973265379
  countingData_ManetStr$Lat = 51.33587391104351
  countingData_MerseburgerStr_Ost$Lat = 51.32
  countingData_MerseburgerStr_West$Lat = 51.32
  countingData_SemmelweisStr$Lat = 51.320809077967255
  countingData_WurznerStr$Lat = 51.32
  
  countingData_EisenbahnStr_Nord$Oneway = FALSE
  countingData_EisenbahnStr_Sued$Oneway = FALSE
  countingData_NuernbergerStr_Ost$Oneway = FALSE
  countingData_NuernbergerStr_West$Oneway = FALSE
  countingData_GerberStr$Oneway = FALSE
  countingData_GorkiStr_Ost$Oneway = FALSE
  countingData_GorkiStr_West$Oneway = FALSE
  countingData_GustavFreytagStr_Nord$Oneway = FALSE
  countingData_GustavFreytagStr_Sued$Oneway = FALSE
  countingData_Jahnallee$Oneway = FALSE
  countingData_KarlLiebknecht$Oneway = FALSE
  countingData_LeneVoigtPark$Oneway = FALSE
  countingData_ManetStr$Oneway = FALSE
  countingData_MerseburgerStr_Ost$Oneway = FALSE
  countingData_MerseburgerStr_West$Oneway = FALSE
  countingData_SemmelweisStr$Oneway = FALSE
  countingData_WurznerStr$Oneway = FALSE
  
#Connect the Stations----------------------------------------------
  
  rawData=rbind(countingData_GerberStr,countingData_Jahnallee)
  rawData=rbind(rawData,countingData_KarlLiebknecht)
  rawData=rbind(rawData,countingData_LeneVoigtPark)
  rawData=rbind(rawData,countingData_ManetStr)
  rawData=rbind(rawData,countingData_SemmelweisStr)
...
#Create Timestamp------------------------------------------------
  ...
  rawData$Date = gsub(" vorm.", "", rawData$Date)
  rawData$Date = gsub(" nachm.", "", rawData$Date)
  
  rawData$Date = paste(rawData$Time,rawData$Date,sep = " ")
  rawData$Time = NULL
