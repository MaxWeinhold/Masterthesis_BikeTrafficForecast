...
#D:\STUDIUM\Münster\7. Semester\Masterarbeit Daten\Ludwigsburg
...
rawData<-rawData[(rawData$standort=="Stadt Ludwisburg"),]
rawData$standort = "Ludwigsburg"
names(rawData)
...
#Import Weather Data
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Ludwigsburg")
...
ADFC_Index=c(3.7,3.7,3.6,3.6,3.7,3.7,3.9,3.9,3.6,3.6)
