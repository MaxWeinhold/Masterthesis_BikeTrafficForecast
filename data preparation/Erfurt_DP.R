...
#D:\STUDIUM\Münster\7. Semester\Masterarbeit Daten\Erfurt
setwd("D:/STUDIUM/Münster/7. Semester/Masterarbeit Daten/Erfurt")

#Read Bycicle Counting Data----------------------------------------------
  countingDataM18 = read.csv(file = "data_2018_Moebisburg.csv",sep=";", encoding="ISO-8859-1")
  countingDataM19 = read.csv(file = "data_2019_Moebisburg.csv",sep=";", encoding="ISO-8859-1")
  countingDataM20 = read.csv(file = "data_2020_Moebisburg.csv",sep=";", encoding="ISO-8859-1")
  countingDataM21 = read.csv(file = "data_2021_Moebisburg.csv",sep=";", encoding="ISO-8859-1")
  countingDataS18 = read.csv(file = "data_2018_Schillerstrasse.csv",sep=";", encoding="ISO-8859-1")
  countingDataS19 = read.csv(file = "data_2019_Schillerstrasse.csv",sep=";", encoding="ISO-8859-1")
  countingDataS20 = read.csv(file = "data_2020_Schillerstrasse.csv",sep=";", encoding="ISO-8859-1")
  countingDataS21 = read.csv(file = "data_2021_Schillerstrasse.csv",sep=";", encoding="ISO-8859-1")

#Connect all years----------------------------------------------
  
  countingData_Moebiusburg=rbind(countingDataM18,countingDataM19)
  countingData_Moebiusburg=rbind(countingData_Moebiusburg,countingDataM20)
  countingData_Moebiusburg=rbind(countingData_Moebiusburg,countingDataM21)
  countingData_SchillerStr=rbind(countingDataS18,countingDataS19)
  countingData_SchillerStr=rbind(countingData_SchillerStr,countingDataS20)
  countingData_SchillerStr=rbind(countingData_SchillerStr,countingDataS21)
  
#Summarize Directions----------------------------------------------
  
  names(countingData_Moebiusburg)
  countingData_Moebiusburg$Value = countingData_Moebiusburg$Anzahl.ankommend + countingData_Moebiusburg$Anzahl.abgehend
  countingData_SchillerStr$Value = countingData_SchillerStr$Anzahl.ankommend + countingData_SchillerStr$Anzahl.abgehend

#Create Timestamp--------------------------------------------------
  
  countingData_Moebiusburg$Datum = paste(countingData_Moebiusburg$Datum,countingData_Moebiusburg$Uhrzeit,sep = " ")
  countingData_SchillerStr$Datum = paste(countingData_SchillerStr$Datum,countingData_SchillerStr$Uhrzeit,sep = " ")

#Delete Columns----------------------------------------------------
  
  countingData_Moebiusburg[2] = NULL
  countingData_Moebiusburg[2] = NULL
  countingData_Moebiusburg[2] = NULL
  countingData_SchillerStr[2] = NULL
  countingData_SchillerStr[2] = NULL
  countingData_SchillerStr[2] = NULL
  
#Rename Columns----------------------------------------------
  
  names(countingData_Moebiusburg)[1]="Timestamp"
  names(countingData_SchillerStr)[1]="Timestamp"
  
#Add Location Columns----------------------------------------------
  
  countingData_Moebiusburg$Town = "Erfurt"
  countingData_SchillerStr$Town = "Erfurt"
  
  countingData_Moebiusburg$Station = "Moebiusburg"
  countingData_SchillerStr$Station = "SchillerStr"
  
  
  countingData_Moebiusburg$Lon = 10.9867316666667
  countingData_SchillerStr$Lon = 11.0367916666667
  
  countingData_Moebiusburg$Lat = 50.9217933333333
  countingData_SchillerStr$Lat = 50.97086
  
  countingData_Moebiusburg$Oneway = FALSE
  countingData_SchillerStr$Oneway = FALSE
  
#Connect the Stations----------------------------------------------
  
  rawData=rbind(countingData_Moebiusburg,countingData_SchillerStr)
